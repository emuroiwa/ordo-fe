<template>
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <div class="w-64 bg-white shadow-lg border-r border-gray-200 fixed inset-y-0 left-0 z-50">
      ...
      <nav class="mt-6 px-3">
        <div class="space-y-1">
          <NuxtLink to="/dashboard" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-3 py-2 text-sm font-medium rounded-md">
          ...
          <NuxtLink to="/dashboard/notifications" class="bg-blue-50 text-blue-600 group flex items-center px-3 py-2 text-sm font-medium rounded-md">
      ...
      <div class="absolute bottom-0 w-full px-6 py-4 border-t border-gray-200">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <img :src="user?.avatar_url || 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face'" alt="User" class="w-10 h-10 rounded-full">
            <div class="ml-3">
        ...
        <div class="px-6 py-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-gray-600">Manage your notifications and stay updated</p>
            </div>
