import { defineComponent, ref, computed, watch, mergeProps, useSSRContext, reactive, unref } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderAttr, ssrRenderStyle, ssrLooseContain, ssrLooseEqual, ssrRenderComponent } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="bg-white p-6 rounded-lg shadow-sm border"><h3 class="text-lg font-semibold text-gray-900 mb-4">Service Location</h3><div class="space-y-4"><div><label class="block text-sm font-medium text-gray-700 mb-2"> Where do you provide this service? * </label><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><label class="${ssrRenderClass([{ "border-blue-500 bg-blue-50": unref(form).location_type === "client_location" }, "flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50"])}"><input${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).location_type, "client_location")) ? " checked" : ""} type="radio" value="client_location" class="sr-only"><div class="flex-1 text-center"><div class="text-2xl mb-2">🏠</div><div class="font-medium">Client&#39;s Location</div><div class="text-sm text-gray-500">I travel to client</div></div></label><label class="${ssrRenderClass([{ "border-blue-500 bg-blue-50": unref(form).location_type === "service_location" }, "flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50"])}"><input${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).location_type, "service_location")) ? " checked" : ""} type="radio" value="service_location" class="sr-only"><div class="flex-1 text-center"><div class="text-2xl mb-2">🏢</div><div class="font-medium">My Location</div><div class="text-sm text-gray-500">Client comes to me</div></div></label><label class="${ssrRenderClass([{ "border-blue-500 bg-blue-50": unref(form).location_type === "online" }, "flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50"])}"><input${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).location_type, "online")) ? " checked" : ""} type="radio" value="online" class="sr-only"><div class="flex-1 text-center"><div class="text-2xl mb-2">💻</div><div class="font-medium">Online Service</div><div class="text-sm text-gray-500">Remote/Virtual</div></div></label></div></div>`);
...
//# sourceMappingURL=ServiceForm-C0MOoWaH.js.map
