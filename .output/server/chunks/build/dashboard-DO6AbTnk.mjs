...
import { ref, computed, mergeProps, unref, withCtx, createBlock, createTextVNode, openBlock, createVNode, toDisplayString, createCommentVNode, defineComponent, resolveComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderList } from 'vue/server-renderer';
import { u as useNotifications } from './useNotifications-BBkwuNEb.mjs';
...
import { u as useProfile } from './useProfile-BSasby9R.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a = unref(profileUser)) == null ? void 0 : _a.avatar_url) || ((_b = unref(user)) == null ? void 0 : _b.avatar)) {
              _push2(`<img${ssrRenderAttr("src", ((_c = unref(profileUser)) == null ? void 0 : _c.avatar_url) || ((_d = unref(user)) == null ? void 0 : _d.avatar) || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face")}${ssrRenderAttr("alt", ((_e = unref(profileUser)) == null ? void 0 : _e.name) || ((_f = unref(user)) == null ? void 0 : _f.name) || "User")} class="w-full h-full object-cover"${_scopeId}>`);
            } else {
              _push2(`<div class="w-full h-full flex items-center justify-center bg-blue-500 text-white text-sm font-bold"${_scopeId}>${ssrInterpolate(unref(userInitials) || (((_g = unref(user)) == null ? void 0 : _g.name) ? unref(user).name.charAt(0).toUpperCase() : "U"))}</div>`);
            }
            _push2(`</div>`);
            ...
            _push2(`</div><div class="ml-3 flex-1 min-w-0"${_scopeId}><div class="text-sm font-medium text-gray-900 truncate"${_scopeId}>${ssrInterpolate(unref(displayName) || ((_h = unref(user)) == null ? void 0 : _h.name) || "User")}</div><div class="text-xs text-gray-500 flex items-center"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(currentRole) === "vendor" ? "Service Provider" : "Customer")}</span>`);
            if (unref(profileUser) && unref(profileCompletion) < 100) {
            ...
            return [
              createVNode("div", { class: "relative" }, [
                createVNode("div", { class: "w-10 h-10 rounded-full overflow-hidden bg-gray-200" }, [
                  ((_i = unref(profileUser)) == null ? void 0 : _i.avatar_url) || ((_j = unref(user)) == null ? void 0 : _j.avatar) ? (openBlock(), createBlock("img", {
                    key: 0,
                    src: ((_k = unref(profileUser)) == null ? void 0 : _k.avatar_url) || ((_l = unref(user)) == null ? void 0 : _l.avatar) || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face",
                    alt: ((_m = unref(profileUser)) == null ? void 0 : _m.name) || ((_n = unref(user)) == null ? void 0 : _n.name) || "User",
                    class: "w-full h-full object-cover"
                  }, null, 8, ["src", "alt"])) : (openBlock(), createBlock("div", {
                    key: 1,
                    class: "w-full h-full flex items-center justify-center bg-blue-500 text-white text-sm font-bold"
                  }, toDisplayString(unref(userInitials) || (((_o = unref(user)) == null ? void 0 : _o.name) ? unref(user).name.charAt(0).toUpperCase() : "U")), 1))
                ]),
                unref(profileUser) && unref(profileCompletion) < 100 ? (openBlock(), createBlock("div", {
                  key: 0,
              ...
              createVNode("div", { class: "ml-3 flex-1 min-w-0" }, [
                createVNode("div", { class: "text-sm font-medium text-gray-900 truncate" }, toDisplayString(unref(displayName) || ((_p = unref(user)) == null ? void 0 : _p.name) || "User"), 1),
                createVNode("div", { class: "text-xs text-gray-500 flex items-center" }, [
                  ...
                  unref(profileUser) && unref(profileCompletion) < 100 ? (openBlock(), createBlock("span", {
                    key: 0,
...
//# sourceMappingURL=dashboard-DO6AbTnk.mjs.map
