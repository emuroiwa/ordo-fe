...
import { c as useNuxtApp, P as PageRouteSymbol, u as useRoute, e as appLayoutTransition, f as _wrapInTransition, L as LayoutMetaSymbol } from './server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-BHbU0EQa.mjs').then((m) => m.default || m))
};
...
//# sourceMappingURL=nuxt-layout-C7uhEWd0.mjs.map
