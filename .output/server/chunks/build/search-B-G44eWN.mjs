  ...
  setup(__props) {
    ...
    const transformServiceForDisplay = (service) => {
      ...
      return {
        id: service.id,
        name: service.title,
        category: ((_a = service.category) == null ? void 0 : _a.slug) || "service",
        categoryName: ((_b = service.category) == null ? void 0 : _b.name) || "Service",
        ...
        image: ((_c = service.primary_image) == null ? void 0 : _c.url) || "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=300&fit=crop",
        availability: ["today"],
        // Mock for now, could be enhanced with real availability
    ...
    const filteredVendors = computed(() => {
      ...
      let filtered = transformedServices.filter((vendor) => {
        const matchesSearch = !searchQuery.value || vendor.name.toLowerCase().includes(searchQuery.value.toLowerCase()) || vendor.categoryName.toLowerCase().includes(searchQuery.value.toLowerCase());
...
//# sourceMappingURL=search-B-G44eWN.mjs.map
