...
import { b as useNuxtApp, P as PageRouteSymbol, u as useRoute, c as appLayoutTransition, d as _wrapInTransition, L as LayoutMetaSymbol } from './server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-DO6AbTnk.mjs').then((m) => m.default || m))
};
...
//# sourceMappingURL=nuxt-layout-C4LaSk2R.mjs.map
